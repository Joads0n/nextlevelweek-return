...
export function FeedbackContentStep({ feedbackType, onFeedbackRestarRequested, onFeedbackSent }: FeedbackContentStepProps) {
    ...
    return (
        <>    
            <header>
                ...
                <span className="text-xl leaing-6 flex items-center gap-2">
